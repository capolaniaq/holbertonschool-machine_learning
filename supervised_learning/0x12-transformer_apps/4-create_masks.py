#!/usr/bin/env python3
"""
creates masks for the attention mechanism
"""
...
def create_masks(inputs, target):
    ...
    Returns:
        ...
        used in the 1st attention block in the decoder to pad and mask future tokens in
        the input received by the decoder. It takes the maximum between a look ahead mask
